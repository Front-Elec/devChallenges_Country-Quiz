...
Start the challenge, submit your solution, and receive feedback from the community.



ℹ️ You can have 3 ongoing challenges at the same time. (3 left)
Learning Goals
...
Technical Details
To fetch country data for the quiz questions, you can use the WorldRanks API. The API provides various endpoints for retrieving country data.
